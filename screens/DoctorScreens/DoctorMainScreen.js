  ...
  return (
    <View style={[global.defaultBackgroundColor, styles.container]}>
      ...
      <View style={styles.actionsMenuContainer}>
        ...
        <View style={styles.actionsMenuButtons}>
          <TouchableOpacity
            onPress={() => navigation.navigate("SeeAssignedExercises")}
            style={styles.button}
          >
        ...
        >
          {patients.slice(0, 3).map((patient, index) => (
            <View
              ...
              style={[
                styles.allContainer,
                index == patients.slice(0, 3).length - 1 &&
                  styles.hideLastPatient,
              ]}
            >
              ...
              <View style={styles.btnView}>
                ...
                >
                  <Text style={[{ color: "#26ae60" }, styles.removeButtonText]}>
                    +
                  </Text>
                </TouchableOpacity>
              </View>
